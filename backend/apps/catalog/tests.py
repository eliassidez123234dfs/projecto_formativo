...
class CategoryModelTests(TestCase):
    ...
    def test_product_count_with_products(self):
        ...
        p = Product.objects.create(name="Test", description="Desc", base_price="10000", is_active=True, is_approved=True)
    ...
    def test_product_count_only_active_approved(self):
        ...
        p1 = Product.objects.create(name="Active", description="Desc", base_price="10000", is_active=True, is_approved=True)
        p2 = Product.objects.create(name="Inactive", description="Desc", base_price="10000")
...
class ProductCategoryModelTests(TestCase):
    def setUp(self):
        ...
        self.product = Product.objects.create(name="Prod1", description="Desc", base_price="10000")
...
class CatalogAPITests(TestCase):
    ...
    def test_catalog_list(self):
        p = Product.objects.create(name="Catalog Product", description="Desc", base_price="25000", is_active=True, is_approved=True)
    ...
    def test_catalog_list_filters_included(self):
        p = Product.objects.create(name="Filter Test", description="Desc", base_price="25000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
        url = reverse("catalog-list")
        response = self.client.get(url, format="json")
    ...
    def test_catalog_only_shows_active_approved(self):
        Product.objects.create(name="Active", description="Desc", base_price="10000", is_active=True, is_approved=True)
        Product.objects.create(name="Inactive", description="Desc", base_price="10000")
        Product.objects.create(name="Not Approved", description="Desc", base_price="10000", is_active=True)
        url = reverse("catalog-list")
        response = self.client.get(url, format="json")
        self.assertEqual(len(response.data["results"]), 1)

    def test_catalog_search_by_name(self):
        p = Product.objects.create(name="Busqueda Test", description="Desc", base_price="25000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
        url = reverse("catalog-list")
    ...
    def test_catalog_search_records_history(self):
        ...
        session.save()
        p = Product.objects.create(name="Hist Test", description="Desc", base_price="25000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
        url = reverse("catalog-list")
    ...
    def test_catalog_search_records_popular(self):
        p = Product.objects.create(name="Popular Test", description="Desc", base_price="25000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
    ...
    def test_catalog_filter_by_category(self):
        ...
        p = Product.objects.create(name="Gadget", description="Desc", base_price="50000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
    ...
    def test_catalog_filter_by_size(self):
        p = Product.objects.create(name="Size Filter", description="Desc", base_price="25000", is_active=True, is_approved=True)
    ...
    def test_catalog_filter_by_color(self):
        p = Product.objects.create(name="Color Filter", description="Desc", base_price="25000", is_active=True, is_approved=True)
    ...
    def test_catalog_filter_by_price_range(self):
        Product.objects.create(name="Cheap", description="Desc", base_price="5000", is_active=True, is_approved=True)
        p2 = Product.objects.create(name="Expensive", description="Desc", base_price="50000", is_active=True, is_approved=True)
        Variant.objects.create(product=p2, size="M", color="Negro", stock=5)
        url = reverse("catalog-list")
        response = self.client.get(url, {"min_price": "10000", "max_price": "100000"}, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data["results"]), 1)

    def test_catalog_filter_by_has_stock(self):
        p1 = Product.objects.create(name="In Stock", description="Desc", base_price="10000", is_active=True, is_approved=True)
        Variant.objects.create(product=p1, size="M", color="Negro", stock=5)
        p2 = Product.objects.create(name="No Stock", description="Desc", base_price="10000", is_active=True, is_approved=True)
...
class CatalogDetailTests(TestCase):
    ...
    def test_retrieve_product(self):
        p = Product.objects.create(name="Detail Test", description="Desc", base_price="25000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
...
class FeaturedDealsAPITests(TestCase):
    ...
    def test_featured_endpoint(self):
        ...
        p = Product.objects.create(name="Featured", description="Desc", base_price="25000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
        ...
        dummy_image = SimpleUploadedFile("test.png", img_io.getvalue(), content_type="image/png")
        ProductImage.objects.create(product=p, image=dummy_image)
    ...
    def test_deals_endpoint(self):
        p = Product.objects.create(name="Deal", description="Desc", base_price="15000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
...
class CategoryAPITests(TestCase):
    ...
    def test_category_products(self):
        ...
        p = Product.objects.create(name="Cat Product", description="Desc", base_price="25000", is_active=True, is_approved=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
        ProductCategory.objects.create(product=p, category=cat)
