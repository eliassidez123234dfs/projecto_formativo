...
class Order(models.Model):
	...
	delivered_at = models.DateTimeField(blank=True, null=True, help_text='Fecha en que se entregó el pedido')
	...
	def save(self, *args, **kwargs):
		...
		Al marcar como entregado, registra la fecha de entrega si aún no existe."""
