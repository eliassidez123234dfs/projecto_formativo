...
class ProductImageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductImage
        fields = ['id', 'product', 'product_id', 'product_name', 'image', 'image_url', 'cloudinary_url', 'is_main', 'order', 'created_at']
        read_only_fields = ['id', 'image_url', 'product_name', 'product_id', 'created_at']
