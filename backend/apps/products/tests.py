...
# â”€â”€â”€ Existing Model Tests (preserved) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


class ProductModelTests(TestCase):
    def test_product_requires_valid_minimum_fields(self):
        product = Product(name='Camiseta Premium', description='Desc', base_price='25000.00')
        product.full_clean()
        product.save()
    ...
    def test_variant_limits_and_uniqueness(self):
        product = Product.objects.create(name='Producto Base', description='Desc', base_price='35000.00')
    ...
    def test_image_requires_main_safe_format_and_resolution(self):
        product = Product.objects.create(name='Producto Imagen', description='Desc', base_price='40000.00')
...
# â”€â”€â”€ New Model Tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


class ProductModelExtendedTests(TestCase):
    def test_product_str(self):
        p = Product.objects.create(name="Test Product", description="Desc", base_price="25000.00")
        self.assertEqual(str(p), "Test Product")

    def test_product_defaults(self):
        p = Product.objects.create(name="Defaults", description="Desc", base_price="100.00")
        self.assertFalse(p.is_active)
        self.assertFalse(p.is_approved)

    def test_product_ordering(self):
        p1 = Product.objects.create(name="First", description="Desc", base_price="100.00")
        p2 = Product.objects.create(name="Second", description="Desc", base_price="100.00")
        qs = Product.objects.all()
        self.assertEqual(qs.first(), p2)

    def test_main_image_property_no_images(self):
        p = Product.objects.create(name="No Images", description="Desc", base_price="100.00")
        self.assertIsNone(p.main_image)

    def test_main_image_property_with_images(self):
        p = Product.objects.create(name="With Images", description="Desc", base_price="100.00")
    ...
    def test_has_main_image_false(self):
        p = Product.objects.create(name="No Main", description="Desc", base_price="100.00")
        self.assertFalse(p.has_main_image)

    def test_has_main_image_true(self):
        p = Product.objects.create(name="Has Main", description="Desc", base_price="100.00")
    ...
    def test_has_valid_variant_false(self):
        p = Product.objects.create(name="No Stock", description="Desc", base_price="100.00")
        self.assertFalse(p.has_valid_variant)

    def test_has_valid_variant_true(self):
        p = Product.objects.create(name="Has Stock", description="Desc", base_price="100.00")
    ...
    def test_can_be_published_both_required(self):
        p = Product.objects.create(name="Publish Test", description="Desc", base_price="100.00")
    ...
    def test_checklist_keys(self):
        p = Product.objects.create(name="Checklist", description="Desc", base_price="100.00")
    ...
    def test_empty_name_validation(self):
        p = Product(name="", description="Desc", base_price="100.00")
        with self.assertRaises(ValidationError):
            p.full_clean()

    def test_empty_description_validation(self):
        p = Product(name="Test", description="", base_price="100.00")
        with self.assertRaises(ValidationError):
            p.full_clean()

    def test_name_too_long(self):
        p = Product(name="A" * 101, description="Desc", base_price="100.00")
        with self.assertRaises(ValidationError):
            p.full_clean()

    def test_description_too_long(self):
        p = Product(name="Test", description="A" * 501, base_price="100.00")
        with self.assertRaises(ValidationError):
            p.full_clean()
    ...
    def test_has_active_order_items_no_orders(self):
        p = Product.objects.create(name="No Orders", description="Desc", base_price="100.00")
        self.assertFalse(p.has_active_order_items)


class VariantModelExtendedTests(TestCase):
    def test_variant_str(self):
        p = Product.objects.create(name="Str Test", description="Desc", base_price="100.00")
    ...
    def test_variant_default_stock(self):
        p = Product.objects.create(name="Default Stock", description="Desc", base_price="100.00")
        v = Variant.objects.create(product=p, size="S", color="Azul")
        self.assertEqual(v.stock, 0)

    def test_variant_negative_stock(self):
        p = Product.objects.create(name="Neg Stock", description="Desc", base_price="100.00")
        v = Variant(product=p, size="S", color="Azul", stock=-1)
        with self.assertRaises(ValidationError):
            v.full_clean()

    def test_variant_empty_size(self):
        p = Product.objects.create(name="Empty Size", description="Desc", base_price="100.00")
        v = Variant(product=p, size="", color="Azul", stock=1)
        with self.assertRaises(ValidationError):
            v.full_clean()

    def test_variant_empty_color(self):
        p = Product.objects.create(name="Empty Color", description="Desc", base_price="100.00")
        v = Variant(product=p, size="M", color="", stock=1)
        with self.assertRaises(ValidationError):
            v.full_clean()

    def test_variant_max_colors(self):
        p = Product.objects.create(name="Max Colors", description="Desc", base_price="100.00")
        ...
        v = Variant(product=p, size="M", color="MarrÃ³n", stock=1)
        with self.assertRaises(ValidationError):
            v.full_clean()

    def test_variant_ordering(self):
        p = Product.objects.create(name="Order Test", description="Desc", base_price="100.00")
    ...
    def test_variant_unique_constraint(self):
        p = Product.objects.create(name="Unique", description="Desc", base_price="100.00")
...
class ProductImageModelExtendedTests(TestCase):
    def test_image_str(self):
        p = Product.objects.create(name="Img Str", description="Desc", base_price="100.00")
    ...
    def test_image_url_cloudinary_priority(self):
        p = Product.objects.create(name="URL Test", description="Desc", base_price="100.00")
    ...
    def test_image_url_fallback(self):
        p = Product.objects.create(name="URL Fallback", description="Desc", base_price="100.00")
    ...
    def test_image_no_source_validation(self):
        p = Product.objects.create(name="No Source", description="Desc", base_price="100.00")
        img = ProductImage(product=p)
        with self.assertRaises(ValidationError):
            img.full_clean()

    def test_image_max_per_product(self):
        p = Product.objects.create(name="Max Img", description="Desc", base_price="100.00")
        for i in range(5):
    ...
    def test_image_auto_set_main(self):
        p = Product.objects.create(name="Auto Main", description="Desc", base_price="100.00")
    ...
    def test_image_auto_increment_order(self):
        p = Product.objects.create(name="Auto Order", description="Desc", base_price="100.00")
    ...
    def test_image_invalid_format(self):
        p = Product.objects.create(name="Bad Format", description="Desc", base_price="100.00")
    ...
    def test_main_image_exclusive(self):
        p = Product.objects.create(name="Exclusive Main", description="Desc", base_price="100.00")
...
class ProductAPITests(TestCase):
    ...
    def test_list_products(self):
        Product.objects.create(name="API Test", description="Desc", base_price="25000.00")
    ...
    def test_retrieve_product(self):
        p = Product.objects.create(name="Retrieve Me", description="Desc", base_price="25000.00")
    ...
    def test_update_product(self):
        p = Product.objects.create(name="Update Me", description="Desc", base_price="25000.00")
        url = reverse("product-detail", args=[p.id])
    ...
    def test_delete_product(self):
        p = Product.objects.create(name="Delete Me", description="Desc", base_price="25000.00")
        url = reverse("product-detail", args=[p.id])
    ...
    def test_list_with_search(self):
        Product.objects.create(name="Red Shoes", description="Desc", base_price="25000.00")
        Product.objects.create(name="Blue Hat", description="Desc", base_price="150.00")
        url = reverse("product-list")
    ...
    def test_list_with_is_active_filter(self):
        Product.objects.create(name="Active", description="Desc", base_price="100.00", is_active=True)
    ...
    def test_list_with_price_filter(self):
        Product.objects.create(name="Cheap", description="Desc", base_price="50.00")
        Product.objects.create(name="Expensive", description="Desc", base_price="200.00")
        url = reverse("product-list")
...
class ProductVariantAPITests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.product = Product.objects.create(name="Variant Product", description="Desc", base_price="25000.00")
...
class ProductImageAPITests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.product = Product.objects.create(name="Img Product", description="Desc", base_price="25000.00")
...
class ProductPublishWorkflowTests(TestCase):
    ...
    def test_publish_fails_without_image(self):
        p = Product.objects.create(name="Publish Fail", description="Desc", base_price="25000.00")
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
    ...
    def test_publish_fails_without_variant(self):
        p = Product.objects.create(name="Publish Fail2", description="Desc", base_price="25000.00")
        ProductImage.objects.create(product=p, cloudinary_url="https://cldn.com/img.png", is_main=True)
        url = reverse("product-publish", args=[p.id])
        response = self.client.post(url, format="json")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_publish_success(self):
        p = Product.objects.create(name="Publish Success", description="Desc", base_price="25000.00")
        ProductImage.objects.create(product=p, cloudinary_url="https://cldn.com/img.png", is_main=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
        url = reverse("product-publish", args=[p.id])
        response = self.client.post(url, format="json")
    ...
    def test_publish_creates_audit(self):
        p = Product.objects.create(name="Publish Audit", description="Desc", base_price="25000.00")
        ProductImage.objects.create(product=p, cloudinary_url="https://cldn.com/img.png", is_main=True)
        Variant.objects.create(product=p, size="M", color="Negro", stock=5)
        url = reverse("product-publish", args=[p.id])
    ...
    def test_checklist_endpoint(self):
        p = Product.objects.create(name="Checklist EP", description="Desc", base_price="25000.00")
    ...
    def test_toggle_active(self):
        p = Product.objects.create(name="Toggle", description="Desc", base_price="25000.00")
...
class ProductSearchAPITests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.p1 = Product.objects.create(name="Camiseta Roja", description="Camiseta de algodon", base_price="25000.00", is_active=True, is_approved=True)
        self.p2 = Product.objects.create(name="Gorra Azul", description="Gorra de beisbol", base_price="150.00", is_active=True, is_approved=True)
    ...
    def test_search_with_is_active_filter(self):
        Product.objects.create(name="Inactive Product", description="Desc", base_price="100.00")
        url = reverse("product-search")
        response = self.client.get(url, {"is_active": "true"}, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        for r in response.data["results"]:
...
class ProductAuditTests(TestCase):
    def test_create_audit(self):
        p = Product.objects.create(name="Audit", description="Desc", base_price="25000.00")
    ...
    def test_audit_str(self):
        p = Product.objects.create(name="Audit Str", description="Desc", base_price="25000.00")
    ...
    def test_audit_actions_choices(self):
        p = Product.objects.create(name="Audit Actions", description="Desc", base_price="25000.00")
    ...
    def test_audit_ordering(self):
        p = Product.objects.create(name="Audit Order", description="Desc", base_price="25000.00")
    ...
    def test_audits_endpoint(self):
        p = Product.objects.create(name="Audit EP", description="Desc", base_price="25000.00")
        ProductAudit.objects.create(product=p, action=ProductAudit.ACTION_CREATED, actor="test")
...
class ProductAddToCartAPITests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.product = Product.objects.create(name="Cart Product", description="Desc", base_price="25000.00", is_active=True, is_approved=True)
