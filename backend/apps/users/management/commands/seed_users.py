...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.WARNING('═' * 50))
        self.stdout.write(f'  Usuario:    admin_red')
        self.stdout.write(f'  Correo:     {admin_email}')
        self.stdout.write(f'  Contraseña: {admin_pass}')
        self.stdout.write(f'  Rol:        Administrador')
        self.stdout.write('')
        self.stdout.write(f'  Usuario:    superadmin')
        self.stdout.write(f'  Correo:     {super_email}')
        self.stdout.write(f'  Contraseña: {super_pass}')
        self.stdout.write(f'  Rol:        Administrador (superuser)')
        self.stdout.write(self.style.WARNING('═' * 50))
