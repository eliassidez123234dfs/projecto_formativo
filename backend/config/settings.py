...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-dev-key-cambiar-en-produccion')
...
# apps.users va primero porque contiene AUTH_USER_MODEL; Django requiere
# que la app del modelo de usuario personalizado esté antes de django.contrib.auth.
INSTALLED_APPS = ['apps.users'] + DJANGO_APPS + [
    app for app in PROJECT_APPS if app != 'apps.users'
] + THIRD_PARTY_APPS
