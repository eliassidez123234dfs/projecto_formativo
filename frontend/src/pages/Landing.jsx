        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5">
          {images.map((_, i) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-200 ${i === idx ? 'bg-red-600 w-5' : 'bg-gray-300 dark:bg-slate-600 hover:bg-gray-400 dark:hover:bg-slate-500'}`}
...
export const Landing = () => {
  ...
  return (
    <div style={{
      ...
      minHeight: '100vh',
      background: 'linear-gradient(135deg, var(--color-bg-secondary, #f8fafc) 0%, var(--color-red-light, #fff1f2) 48%, var(--color-bg-tertiary, #f1f5f9) 100%)',
      ...
      <section className="relative overflow-hidden">
        <div className="pointer-events-none absolute -top-24 -right-24 w-[420px] h-[420px] rounded-full bg-red-200/40 dark:bg-red-900/20 blur-3xl" />
        <div className="pointer-events-none absolute top-40 -left-32 w-[360px] h-[360px] rounded-full bg-rose-100/60 dark:bg-rose-900/20 blur-3xl" />
        ...
        <div className="relative max-w-7xl !mx-auto !px-4 sm:!px-6 lg:!px-8 !py-16 md:!py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex flex-wrap gap-3">
              {loggedIn ? (
                ...
                <>
                  ...
                  <Link to="/register" className="!px-7 !py-3 rounded-lg border border-red-200 dark:border-red-800 bg-white/70 dark:bg-slate-800/70 !text-red-600 font-semibold !text-sm hover:bg-red-50 dark:hover:bg-red-900/30 hover:border-red-300 transition-colors duration-200 no-underline inline-flex items-center justify-center">
                    Crear cuenta
                  </Link>
                </>
              )}
          ...
          <div className="w-full aspect-[4/3] bg-gradient-to-br from-red-50 to-white dark:from-red-950/30 dark:to-slate-800 rounded-3xl flex items-center justify-center border border-white/80 dark:border-slate-700/80 overflow-hidden">
      ...
      {/* ─── FEATURES ─── */}
      <section className="border-t border-gray-200/70 dark:border-slate-700/70 !py-16 md:!py-24 !px-4 sm:!px-6 lg:!px-8">
        <div className="max-w-7xl !mx-auto">
          <div className="text-center !mb-14">
            ...
            <p className="!text-gray-500 dark:!text-slate-400">Todo lo que necesitas para crear tus camisetas personalizadas.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <div key={i} className="group !p-7 border border-white/80 dark:border-slate-700/80 rounded-2xl bg-white/55 dark:bg-slate-800/55 transition-all duration-200 shadow-[0_14px_32px_rgba(30,30,30,0.06),inset_0_1px_0_rgba(255,255,255,0.85)] dark:shadow-[0_14px_32px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-lg hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(90,20,30,0.14),inset_0_1px_0_rgba(255,255,255,0.9)] dark:hover:shadow-[0_20px_40px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.08)]">
                <div className="!mb-5 inline-flex items-center justify-center w-12 h-12 rounded-xl bg-red-50 dark:bg-red-950/40 border border-red-100 dark:border-red-900/50">
                  {f.icon}
                </div>
      ...
      {/* ─── CÓMO FUNCIONA ─── */}
      <section className="border-t border-gray-200/70 dark:border-slate-700/70 !py-16 md:!py-24 !px-4 sm:!px-6 lg:!px-8 bg-white/40 dark:bg-slate-900/40">
        <div className="max-w-7xl !mx-auto">
          <div className="text-center !mb-14">
            <span className="inline-block text-xs font-bold uppercase tracking-[0.2em] !text-red-600 !mb-3">
              Proceso simple
            ...
            <p className="!text-gray-500 dark:!text-slate-400">Tres pasos para crear tu camiseta personalizada.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((s, i) => (
              <div key={i} className="text-center !p-8 rounded-2xl bg-white/60 dark:bg-slate-800/60 border border-white/80 dark:border-slate-700/80 shadow-[0_10px_28px_rgba(30,30,30,0.05)] dark:shadow-[0_10px_28px_rgba(0,0,0,0.2)] backdrop-blur-lg">
      ...
      <section className="border-t border-gray-200/70 dark:border-slate-700/70 !py-16 md:!py-24 !px-4 sm:!px-6 lg:!px-8">
        <div className="max-w-7xl !mx-auto">
          <div className="text-center !mb-14">
            ...
            <p className="!text-gray-500 dark:!text-slate-400">Descubre las opciones más populares de nuestros clientes.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 !mb-10">
            {products.slice(0, 3).map((item) => (
              <Link
                key={item.id}
                to={`/product/${item.id}`}
                className="group rounded-2xl border border-white/80 dark:border-slate-700/80 bg-white/55 dark:bg-slate-800/55 overflow-hidden shadow-[0_14px_32px_rgba(30,30,30,0.06)] dark:shadow-[0_14px_32px_rgba(0,0,0,0.2)] backdrop-blur-lg transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(90,20,30,0.14)] dark:hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] no-underline"
              >
                <div className="h-56 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center overflow-hidden">
                  {item.main_image ? (
                    <img
                      src={item.main_image}
                      alt={item.name}
                ...
                <div className="!p-5">
                  <h3 className="!mb-1 !text-gray-900 dark:!text-slate-100">{item.name}</h3>
                  <p className="!text-red-600 font-bold">${Number(item.base_price).toLocaleString('es-CO')}</p>
                </div>
              </Link>
            ))}
            {products.length === 0 && [1, 2, 3].map(n => (
              <div key={n} className="rounded-2xl border border-white/80 dark:border-slate-700/80 bg-white/55 dark:bg-slate-800/55 overflow-hidden shadow-[0_14px_32px_rgba(30,30,30,0.06)] dark:shadow-[0_14px_32px_rgba(0,0,0,0.2)] backdrop-blur-lg animate-pulse">
          ...
          <div className="text-center">
            <Link to="/catalog" className="inline-flex items-center gap-2 !px-8 !py-3 rounded-lg border border-red-200 dark:border-red-800 bg-white/70 dark:bg-slate-800/70 !text-red-600 font-semibold !text-sm hover:bg-red-50 dark:hover:bg-red-900/30 hover:border-red-300 transition-colors duration-200 no-underline">
      ...
      {/* ─── CONTACTO ─── */}
      <section id="contact" className="border-t border-gray-200/70 dark:border-slate-700/70 !py-16 md:!py-24 !px-4 sm:!px-6 lg:!px-8 bg-white/40 dark:bg-slate-900/40">
        <div className="max-w-7xl !mx-auto">
          <div className="text-center !mb-12">
            ...
            <p className="!text-gray-500 dark:!text-slate-400">¿Tienes preguntas? Nos encantaría escuchar de ti.</p>
          </div>
          <div className="flex justify-center">
            <form onSubmit={handleSubmitContacto} className="bg-white/65 dark:bg-slate-800/65 border border-white/85 dark:border-slate-700/85 rounded-2xl !p-8 flex flex-col gap-5 w-full max-w-lg shadow-[0_20px_44px_rgba(30,30,30,0.1),inset_0_1px_0_rgba(255,255,255,0.9)] dark:shadow-[0_20px_44px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-xl">
              {message && <div className="!px-4 !py-2.5 bg-green-50 dark:bg-green-900/30 !text-green-800 dark:!text-green-300 rounded-lg !text-sm border border-green-200 dark:border-green-800">{message}</div>}
              {errors.general && <div className="!px-4 !py-2.5 bg-red-50 dark:bg-red-900/30 !text-red-800 dark:!text-red-300 rounded-lg !text-sm border border-red-200 dark:border-red-800">{errors.general}</div>}

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="nombre" className="block !text-sm font-semibold !text-gray-800 dark:!text-slate-200 !mb-1.5">Nombre</label>
                  <input
                    id="nombre" type="text" name="nombre" value={formData.nombre} onChange={handleChange}
                    placeholder="Tu nombre" required
                    className="w-full !px-4 !py-2.5 rounded-lg border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-900 !text-gray-900 dark:!text-slate-100 !text-sm outline-none focus:ring-2 focus:ring-red-300 focus:border-transparent transition-shadow"
                  />
                </div>
                <div>
                  <label htmlFor="correo" className="block !text-sm font-semibold !text-gray-800 dark:!text-slate-200 !mb-1.5">Correo</label>
                  <input
              ...
              <div>
                <label htmlFor="asunto" className="block !text-sm font-semibold !text-gray-800 dark:!text-slate-200 !mb-1.5">Asunto</label>
                <input
              ...
              <div>
                <label htmlFor="mensaje" className="block !text-sm font-semibold !text-gray-800 dark:!text-slate-200 !mb-1.5">Mensaje</label>
                <textarea
                  id="mensaje" name="mensaje" value={formData.mensaje} onChange={handleChange}
                  placeholder="Escribe tu mensaje aquí..." rows={4} required
                  className="w-full !px-4 !py-2.5 rounded-lg border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-900 !text-gray-900 dark:!text-slate-100 !text-sm outline-none resize-y min-h-[100px] focus:ring-2 focus:ring-red-300 focus:border-transparent transition-shadow"
                />
              </div>
              ...
              <p className="!text-xs !text-gray-400 dark:!text-slate-500 text-center">Máximo 3 mensajes por hora</p>
            </form>
          </div>
        </div>
      </section>
      ...
      {/* ─── FOOTER ─── */}
      <footer className="bg-gray-950 dark:bg-black !text-gray-400 dark:!text-slate-500">
        <div className="max-w-7xl !mx-auto !px-4 sm:!px-6 lg:!px-8 !pt-16 !pb-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 !mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex gap-3">
                <span className="w-9 h-9 rounded-full bg-gray-800 dark:bg-slate-700 flex items-center justify-center !text-gray-400 hover:bg-red-600 hover:!text-white transition-colors cursor-pointer">
          ...
          <div className="border-t border-gray-800 dark:border-slate-700 !pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="!text-xs !text-gray-500 dark:!text-slate-500">
              &copy; {new Date().getFullYear()} RED — Red de Estampación. Todos los derechos reservados.
            </p>
            <div className="flex gap-5">
              <a href="#terms" className="!text-xs !text-gray-500 dark:!text-slate-500 hover:!text-gray-300 transition-colors">Términos</a>
              <a href="#privacy" className="!text-xs !text-gray-500 dark:!text-slate-500 hover:!text-gray-300 transition-colors">Privacidad</a>
              <a href="#cookies" className="!text-xs !text-gray-500 dark:!text-slate-500 hover:!text-gray-300 transition-colors">Cookies</a>
            </div>
          </div>
        </div>
      </footer>
