...
/** Actualiza solo los datos del usuario sin tocar los tokens. */
export function updateUser(userData) {
  currentUser = userData || null
  if (userData) writeLS(LS_USER, JSON.stringify(userData))
...
export function restoreSession() {
  ...
  // Usar axios directo (sin interceptor) para evitar loops de refresh
  const baseURL = (import.meta.env?.VITE_API_URL || '/api/').replace(/\/+$/, '')
  _pendingRestore = axios.post(`${baseURL}/token/refresh/`, { refresh })
    .then(res => {
